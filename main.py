    ...
    while True:
        ...
        if command in ["close", "exit"]:
            ...
            try:
                ...
                print("Please provide valid arguments: add [name] [phone]")
            ...
            try:
                ...
                print("Please provide valid arguments: change [name] [old_phone] [new_phone]")
            ...
            try:
                ...
                print("Please provide valid arguments: phone [name]")
